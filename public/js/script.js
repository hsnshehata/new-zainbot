...
(function() {
  ...
  const langTranslations = {
    en: {
      ...
      bento_card6_desc: '8 specialized AI critics simulate skeptical customers, auditors, and competitors to stress-test your business ideas, find fatal flaws, and build a 7-day MVP plan before writing code.',
    ...
    ar: {
      ...
      bento_card6_desc: '8 وكلاء ذكاء اصطناعي متخصصين يحاكون العملاء، المدققين الماليين، والمنافسين لاختبار جدوى أفكارك التجارية واكتشاف الثغرات وتصميم خطة MVP لـ 7 أيام قبل كتابة سطر كود واحد.',
